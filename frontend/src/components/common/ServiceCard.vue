...
const icons = {
  globe: h('svg', { fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
  ...
  plug: h('svg', { fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
  ...
  headset: h('svg', { fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
...
const iconComponent = computed(() => icons[props.icon] || icons.code)
</script>
